...
export const metadata: Metadata = {
  title: "About",
  description:
    "Learn how SustainYapri estimates personal carbon footprints and why its calculator keeps data private in the browser.",
};
...
const principles = [
  {
    title: "Privacy First",
    description:
      "Your calculator inputs stay in session storage on your device. SustainYapri has no backend, database, or account system.",
    icon: Shield,
  ...
  return (
    <section className="section-container py-14 sm:py-20">
      <div className="max-w-3xl">
        <h1 className="page-title">About SustainYapri</h1>
        <div className="page-subtitle space-y-5">
          <p>
            SustainYapri exists to make personal climate impact easier to understand. It translates everyday activities into annual carbon estimates that are concrete enough to act on.
          </p>
          <p>
